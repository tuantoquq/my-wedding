...
export default function StoryLine({ image, title, description, year, index }: Props) {
    ...
    return (
        index % 2 === 0 ?
            ...
            <div className={`z-10 w-full p-5 sm:p-10 flex flex-col md:flex-row-reverse gap-5 relative items-center shadow-[0_0px_80px_-20px_rgba(0,0,0,0.2)] justify-between relative`}>
                <div className='basis-full md:basis-5/12 shrink-0 flex justify-center'>
                    <Image
                        className='w-full aspect-square rounded-lg object-center object-cover shadow-none'
                        src={image}
