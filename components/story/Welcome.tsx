...
export default function Welcome() {
    ...
    return (
        <div className="p-5 sm:p-16 md:p-24 mt-32 h-[16rem] sm:h-[24rem] md:h-[30rem] lg:h-[32rem] bg-cover bg-no-repeat bg-[center] sm:bg-[center_top_40%] md:bg-[center_top_35%] bg-[url('/HUY09969.jpg')] w-full flex flex-col gap-5 relative items-center justify-center relative">
