...
export default function Welcome() {
  return (
    <div
      className="p-5 sm:p-16 md:p-24 mt-24 h-[18rem] sm:h-[24rem] md:h-[30rem] lg:h-[32rem] bg-cover bg-no-repeat bg-[center_top_40%] 
    ...
    >
      ...
      <h1 className="text-[2rem] sm:text-[3rem] lg:text-[4rem] text-white font-semibold z-20">
      ...
      <h2 className="text-[0.8rem] sm:text-[1rem] lg:text-[1.25rem] text-white font-light z-20 italic">
        ...
        the viewer. Gregor then turned to look out”
      </h2>
    </div>
  );
}
